...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 321770548138863823, ; hash 0x477289bd4ffeccf, from name: aot-BluetoothApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3183704708866338887, ; hash 0x2c2eca9091b77047, from name: libaot-BluetoothApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	...
	%struct.DSOCacheEntry {
		i64 4907581130067718720, ; hash 0x441b3b094c18b240, from name: aot-BluetoothApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 7200982046111457805, ; hash 0x63ef0704bc70620d, from name: libaot-BluetoothApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 164
	...
	%struct.DSOCacheEntry {
		i64 16415179827323217543, ; hash 0xe3ce6f14e3c22687, from name: BluetoothApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 428
	...
	%struct.DSOCacheEntry {
		i64 18240192241007710171, ; hash 0xfd222e33d819cfdb, from name: BluetoothApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BluetoothApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
...
@.env.3 = private unnamed_addr constant [37 x i8] c"caf0523a-8a73-4998-8dfc-f25ea50a08b3\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"Petza_Software.Petza_Software\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-BluetoothApp.dll.so\00", align 16
